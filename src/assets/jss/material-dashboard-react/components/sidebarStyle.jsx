...
const sidebarStyle = theme => ({
  ...
  logo: {
    ...
    "&:after": {
      ...
      right: "15px",
      width: "calc(100% - 30px)",
      backgroundColor: "rgba(200, 180, 200, 1)"
    }
  },
 logoLink: {
    ...defaultFont,
  ...
  blue: {//i change it to purpule
    backgroundColor: primaryColor,
    boxShadow:
      "0 12px 20px -10px rgba(0,188,212,.28), 0 4px 20px 0 rgba(0,0,0,.12), 0 7px 8px -5px rgba(0,255,212,.2)",
    "&:hover": {
      backgroundColor: primaryColor,
      boxShadow:
